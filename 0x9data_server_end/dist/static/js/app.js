...
/* harmony default export */ __webpack_exports__["default"] = ({
  // 这个字段走 app.json
  config: {
    pages: ['pages/logs/logs', 'pages/index/index', '^pages/add/add'], // 页面前带有 ^ 符号的，会被编译成首页，其他页面可以选填，我们会自动把 webpack entry 里面的入口页面加进去
    window: {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56276250", Component.options)
  } else {
    hotAPI.reload("data-v-56276250", Component.options)
  }
